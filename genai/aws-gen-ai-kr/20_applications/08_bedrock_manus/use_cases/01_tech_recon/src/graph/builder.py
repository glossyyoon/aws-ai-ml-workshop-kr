...
def build_graph():
    ...
    router_planner = FunctionNode(func=router_planner_node, name="router_planner")
    supervisor = FunctionNode(func=supervisor_node, name="supervisor")

    builder.add_node(clarifier, "clarifier")
    # builder.add_node(human_feedback, "human_feedback")
    builder.add_node(planner, "planner")
    builder.add_node(router_planner, "router_planner")
    ...
    builder.set_entry_point("router_planner")

    # builder.add_edge("clarifier", "planner")  # Commented out since clarifier is not used
    # builder.add_edge("clarifier", "human_feedback")
    # builder.add_edge("human_feedback", "planner")
    # builder.add_edge("planner", "supervisor")
    builder.add_edge("router_planner", "supervisor")
